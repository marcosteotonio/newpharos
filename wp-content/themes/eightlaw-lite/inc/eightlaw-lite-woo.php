...
remove_action('woocommerce_sidebar','woocommerce_get_sidebar');
	add_action('eightlaw_lite_sidebar','woocommerce_get_sidebar',10); // for sidebar	
	add_action('eightlaw_lite_breadcrumb','woocommerce_breadcrumb',10); //for breaddcrumb
...
//////////////// for all woocomerce pages ends////////////////
	...
	add_action('woocommerce_before_shop_loop', 'eightlaw_lite_primary', 0);	// page header of  archive woocommerce page
	add_action('woocommerce_before_single_product', 'eightlaw_lite_primary', 0);// page header for single product
