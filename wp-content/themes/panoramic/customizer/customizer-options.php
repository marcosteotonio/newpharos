...
function panoramic_customizer_library_options() {
    ...
    $options['panoramic-default-slider-info'] = array(
    	...
    	'section' => $section,
    	'type'    => 'info',
    	'description' => __( '<a href="http://www.outtheboxthemes.com/documentation/panoramic/homepage-slider/default-slider/" target="_blank">Read a guide on how to set up the Default Slider</a>', 'panoramic' ),
    );
    ...
    $options['panoramic-slider-plugin-info'] = array(
    	...
    	'section' => $section,
    	'type'    => 'info',
    	'description' => __( '<a href="http://www.outtheboxthemes.com/documentation/panoramic/homepage-slider/slider-plugin/" target="_blank">Read a guide on using a slider plugin</a>', 'panoramic' ),
    );
